...
(function (global, factory) {
  ...
  const ascendingBisect$1 = bisector$1(d3Ascending);
  ...
  function time() {
    return initRange$1.apply(calendar(timeTicks, timeTickInterval, year$1, month, sunday$1, day$1, hour, minute, second, timeFormat).domain([new Date(2000, 0, 1), new Date(2000, 0, 2)]), arguments);
  }

  function utcTime() {
    return initRange$1.apply(calendar(utcTicks, utcTickInterval, utcYear$1, utcMonth, utcSunday$1, utcDay$1, utcHour, utcMinute, second, utcFormat).domain([Date.UTC(2000, 0, 1), Date.UTC(2000, 0, 2)]), arguments);
  }
